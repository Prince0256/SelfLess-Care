...
public class MyMentalAdapter extends RecyclerView.Adapter<MyMentalAdapter.MyViewHolder> {
    private Context context;
    private ArrayList name,email,mobile_number,title;

    public MyMentalAdapter(Context context, ArrayList name, ArrayList email, ArrayList mobile_number, ArrayList title) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(context).inflate(R.layout.mental_care,parent,false);
